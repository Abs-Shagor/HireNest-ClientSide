    ...
    return (
        <div className='border border-[#93c0b4] sm:border-white shadow2 rounded-xl'>
            <div className='relative flex gap-5 p-5'>
                <div>
                    <img src="../../public/company_logo/3.jfif" alt="img" className='h-15 w-15 shadow2 scale1 ' />
                </div>
                ...
                <div className='flex-1 grid gap-5'>
                    <div className='flex justify-between'>
                        <div>
                            <h3 className='text-[22px] text-[#003D20] font-semibold '>Web Developer</h3>
                            <div className='flex gap-1 text-[14px] text-clr2 '>
                                <p>BRAC GROUP</p>
                                <p>|</p>
            ...
            <div className='flex gap-5 justify-between items-center bg-green-50 rounded-b-xl  px-5 py-2'>
                <div className='text-clr2 text-[14px] '>Posted <span>3</span> mins ago </div>
