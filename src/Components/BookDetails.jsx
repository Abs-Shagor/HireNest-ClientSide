    ...
    return (
        <div>
            ...
            <div className=' flex flex-col lg:flex-row gap-10 mb-10 mt-10 sm:mt-20'>
                <div className='flex-1/3 bg-[#f3f3f3]  flex justify-center rounded-xl  py-15'>
                    <img src={book.image} alt="" className='h-[321px] w-[221px] rounded-md shadow-[0_10px_10px_black] -rotate-15' />
                </div>
                    ...
                    <div className='flex gap-3 mt-3'>
                        {
                            book.tags.map(tag => {
                                return (
                                    <p key={book.id} className=' text-[#003D20] italic font-semibold '>#{tag} </p>
                                )
                            })
                        }
                    </div>
