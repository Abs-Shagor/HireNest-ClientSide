    ...
    return (
        <div className="min-h-screen flex flex-col gap-10 justify-center items-center">
            <div className=" max-w-[360px] border border-gray-500 p-10 rounded-xl ">
                ...
                <p className="text-gray-700 text-justify mt-5">To verify your email , we've sent a mail to your Email address. Please check your inbox or <span className="font-semibold">spam</span> folder.</p>
            </div>
        </div>
    );
};
