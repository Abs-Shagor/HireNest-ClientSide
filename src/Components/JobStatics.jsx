    ...
    return (
        <div className='grid gap-10 mt-10' >
            ...
            <div className="flex justify-between  ">
                <div className=' bg-green-50 hover:bg-green-100 h-[120px] w-[200px] cursor-pointer rounded-t-xl p-5 border-b-5 border-b-green-500'>
                    <div className="flex items-center justify-between">
                        <p className="text-[34px] text-green-500 font-semibold ">56</p>
                        <MdWork className="w-10 h-10 text-green-500 " />
                    </div>
                    <p className="text-[18px] text-green-400 mt-2">Application Sent</p>
                </div>
                <div className=' bg-amber-50 hover:bg-amber-100 cursor-pointer h-[120px] w-[200px] rounded-t-xl p-5 border-b-5 border-b-amber-500'>
                    <div className="flex items-center justify-between">
                        <p className="text-[34px] text-amber-500 font-semibold ">2k+</p>
                        <IoMdEye className="w-10 h-10 text-amber-500 " />
                    </div>
                    <p className="text-[18px] text-amber-400 mt-2">Profile Viewed</p>
                </div>
                <div className=' bg-blue-50 hover:bg-blue-100 cursor-pointer h-[120px] w-[200px] rounded-t-xl p-5 border-b-5 border-b-blue-500'>
                    <div className="flex items-center justify-between">
                        <p className="text-[34px] text-blue-500 font-semibold ">06</p>
                        <SlCalender className="w-10 h-10 text-blue-500 " />
                    </div>
                    <p className="text-[18px] text-blue-400 mt-2">Interview Schedule</p>
                </div>
                <div className=' bg-purple-50 hover:bg-purple-100 cursor-pointer h-[120px] w-[200px] rounded-t-xl p-5 border-b-5 border-b-purple-500'>
                    <div className="flex items-center justify-between">
                        <p className="text-[34px] text-purple-500 font-semibold ">39</p>
                        <IoMdShareAlt className="w-10 h-10 text-purple-500 " />
                    </div>
                    <p className="text-[18px] text-purple-400 mt-2">App. Answered</p>
                </div>
                <div className=' bg-orange-50 hover:bg-orange-100 cursor-pointer h-[120px] w-[200px] rounded-t-xl p-5 border-b-5 border-b-orange-500'>
                    <div className="flex items-center justify-between">
                        <p className="text-[34px] text-orange-500 font-semibold ">07</p>
                    ...
                    <div className="flex gap-5">
                        ...
                        <div className="flex flex-col gap-5 ">
                            <div className="flex items-center gap-3">
                                <div className="w-5 h-5 rounded-full bg-[#007456]"></div>
                                <div className=" ">
                                    <p className="font-semibold">170</p>
                                    <p className="text-gray-500 text-[18px]">Followers</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-3">
                                <div className="w-5 h-5 rounded-full bg-[#FFB347]"></div>
                                <div className=" ">
                                    <p className="font-semibold">210</p>
                                    <p className="text-gray-500 text-[18px]">Following</p>
                                </div>
                            </div>
                        </div>
                    </div>
